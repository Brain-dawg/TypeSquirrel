...
function average(numbers: array<int>): float {
    local sum: int = 0;
...
student.addGrade(90);
student.addGrade(85);
local avgGrade: float = student.getAverage();
'''
...
local numbers: array<int> = ["a", "b"];  // Wrong element type

function test(x: int): string {
